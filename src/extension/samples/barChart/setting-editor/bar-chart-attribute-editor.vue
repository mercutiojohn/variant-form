<template>
  <div>
    <el-form-item label="竖展示" label-width="110px">
      <el-switch
        v-model="selectedWidget.options.setup.verticalShow"
        size="mini"
      />
    </el-form-item>
    ...
    <el-form-item label="柱状图高度" label-width="110px">
      <el-input-number
            size="mini"
            style="width:100%"
    ...
    <el-collapse>
      <el-collapse-item title="柱体设置">
        <el-form-item label="柱体宽度" label-width="110px">
          <el-slider
            v-model="selectedWidget.options.setup.maxWidth"
            :min="1"
            :max="100"
          />
        </el-form-item>
        <el-form-item label="柱体圆角" label-width="110px">
          <el-slider
            v-model="selectedWidget.options.setup.radius"
            :min="0"
            :max="50"
          />
        </el-form-item>
      ...
      <el-collapse-item title="数值设置">
        ...
        <el-form-item label="距离" label-width="110px">
          <el-input-number
            size="mini"
            style="width:100%"
            v-model.trim="selectedWidget.options.setup.distance"
            controls-position="right"
            :max="9999"
            :min="0"
          />
    ...
    <el-dialog title="动态数据编辑" :visible.sync="showDynamicDialogFlag"  width="22%"
...
<script>
  ...
  export default {
    name: "bar-chart-attribute-editor",
