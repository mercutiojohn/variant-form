...
import queryform from'@/extension/samples/el-table/anji/anji-crud/mixins/queryform'
  export default {
    name: "WidgetPiechart",
    components: {},
    props: {
    ...
    created() {
      this.optionsStyle = this.option.position;
      this.optionsData = this.option.data;
      this.optionsCollapse = this.option.collapse;
      this.optionsSetup = this.option.setup;
      this.editorOptions();
    },
    beforeDestroy() {
    ...
    methods: {
      ...
      setOptionsLegend() {
        ...
        legend.left = optionsSetup.lateralPosition == "center" ? "center" : "auto";
