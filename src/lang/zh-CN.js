export default {
  ...
  designer: {
    ...
    setting: {
      ...
      customInitApiCollapse: '初始化接口',
      customInitStatus: '初始化条件',
      customInitApi: '接口地址',
      customInitApiEdit: '接口配置',
      customToggleBtn: '配置',
      showActionBar: '使用操作栏',
      actionBarPosition: '操作栏位置',
      actionBarAlign: '操作栏对齐',
      customHeadButtons: '自定义操作栏操作',
      ...
      dsRequestValueRouterVariableType: '路由变量',
